...
train_data_path = r'data\beer\beer.csv'  # 학습 데이터 파일 경로
new_data_path = r'data\_weather_info\weekends_only.csv'  # 예측에 사용할 새로운 데이터 파일 경로
model_save_path =r'model\beer\new_gru_beer.pth'  # 학습된 GRU 모델 가중치 파일 경로
arima_model_save_path = r'model\beer\new_arima_model_beer.pkl'  # 학습된 ARIMA 모델 파일 경로

# 학습 데이터 불러오기 및 스케일러 설정
train_data = pd.read_csv(train_data_path, encoding='cp949')# , encoding='cp949'
...
with open(r'data\beer\beer_forecasting.txt', 'w') as f:
